...
Если слово содержит окончание, характерное для фамилии (например,
окончание "-ов" характерно для русских фамилий "Усов", "Хвостов", "Котов"),
то часть до окончания принимается за лемму, часть после окончания
отбрасывается, и лемма плюс окончание склоняется.
